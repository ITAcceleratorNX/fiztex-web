 ...
 * и психолог (PSYCHOLOGIST-001 §1) — тот же случай, школьного профиля не заводит.
 *
 * Одна модалка на все роли, а не по одной на каждую: набор полей общий, различается
