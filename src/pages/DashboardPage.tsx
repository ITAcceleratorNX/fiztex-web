...
import { ClipboardList, BookMarked, ArrowRight } from 'lucide-react';
  ...
  return (
    <div>
      ...
      <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-3">
        ...
        <StatCard label="Активных тестов" value={activeTests || '—'} />
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500">Тесты, поступающие и назначения</p>
            </div>
          </div>
          <ArrowRight className="h-5 w-5 text-slate-400" />
        </Link>
