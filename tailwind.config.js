  ...
  theme: {
    extend: {
      ...
      height: {
        ...
        'slot-row-lg': '72px',
        // Журнал посещаемости учителя за месяц (2170:2360): шапка дней и строка ученика.
        'journal-head': '52px',
        'journal-row': '44px',
      },
      width: {
        ...
        'filter-select': '200px',
        // Журнал посещаемости учителя (2170:2360): колонка ФИО и колонка дня.
        'journal-name': '200px',
        'journal-day': '50px',
        ...
        // Колонки таблицы учебников (Figma 2149:3157). «Название» тянется, остальные держат ширину.
        'col-textbook-type': '72px',
        'col-textbook-class': '112px',
        'col-textbook-subject': '210px',
        'col-textbook-period': '250px',
        'col-textbook-actions': '262px',
      },
      minWidth: {
        // Ниже этого сетка занятости уезжает в свой горизонтальный скролл,
        // чтобы дни не схлопывались в нечитаемые колонки.
        'slot-grid': '640px',
        // Таблица учебников: пять колонок держат ширину, и уже этого «Название» схлопывается —
        // таблица уходит в свой горизонтальный скролл, как сетка занятости.
        'textbook-table': '1120px',
      },
      minHeight: {
      ...
      maxHeight: {
        ...
        'class-list': '320px',
        // Окно журнала посещаемости (2170:2360, `table-viewport`): в макете 562 px при экране
        // 950 — всё, что остаётся под шапкой, фильтрами и легендой. Поэтому от высоты экрана,
        // а не числом: на ноутбуке таблица иначе уезжала бы за нижний край вместе с полосой
        // горизонтальной прокрутки.
        'journal-viewport': 'calc(100vh - 20rem)',
      },
      borderWidth: {
